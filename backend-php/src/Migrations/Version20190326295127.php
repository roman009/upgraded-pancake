 ...
 */
final class Version20190326295127 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE google_calendar_event ADD real_end_time DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE google_calendar_event DROP real_end_time');
